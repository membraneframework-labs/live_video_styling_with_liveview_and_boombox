...
`);
  ...
  // ../../assets/capture.js
  function createCaptureHook(iceServers2 = [{ urls: "stun:stun.l.google.com:19302" }]) {
    return {
      async mounted() {
        this.handleEvent("media_constraints-" + this.el.id, async (mediaConstraints) => {
          ...
          const pcConfig = { iceServers: iceServers2 };
  ...
  // ../../assets/player.js
  function createPlayerHook(iceServers2 = [{ urls: "stun:stun.l.google.com:19302" }]) {
    return {
      async mounted() {
  ...
  Hooks2.Capture = createCaptureHook(iceServers);
